...
https://better-call.dev/ghostnet/KT1WEVRHFcRq8n9iefMNm2s9P2gbB1d5gVzH/operations
...
```
cd ./server && yarn && CONTRACT_ADDRESS='KT1Puh2L7yZjcCW3vhJEwoHL9hP4879VrGbD' SERVER_NAME='NYC' node src/index.js
```
